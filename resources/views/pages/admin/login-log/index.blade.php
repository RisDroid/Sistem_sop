...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
        <div>
            <h4 class="fw-bold mb-1">Log Login Sistem</h4>
            <div class="text-muted">Riwayat login dan logout pengguna di dalam sistem.</div>
        </div>
    </div>
        ...
        <div class="card-body">
            <form method="GET" class="row g-3 align-items-end">
                ...
                <div class="col-md-4 d-flex gap-2">
                    ...
                    <a href="{{ route('admin.login-log.index') }}" class="btn btn-outline-secondary">Reset</a>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    @forelse($logs as $log)
                        <tr>
                            ...
                            <td>
                                ...
                                <small class="text-muted">{{ $log->username ?? '-' }}</small><br>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-center py-5 text-muted">Belum ada log login yang tercatat.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
